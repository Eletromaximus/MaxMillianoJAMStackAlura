  ...
  return (
    ...
    >
      ...
      <Grid.Container>
        ...
        <OrdinaryRow>
          <Grid.Row>
            <Card url={'https://github.com/Eletromaximus/semanaomnistack11/blob/master/x2.png?raw=true'}
              title='Semana Omnistack 11'
              alt='semana omnistack 11'
              href='https://github.com/Eletromaximus/semanaomnistack11'
            /> 
            <Card url={'https://github.com/Eletromaximus/NLW3/blob/master/x.png?raw=true'}
              title='Next Level Week 3'
              alt='next level week 3'
              href='https://github.com/Eletromaximus/NLW3'
            /> 
            <Card url={'https://github.com/Eletromaximus/InstaAlura/raw/main/instaAlura.png'}
              title='InstaAlura'
              alt='instaAlura'
